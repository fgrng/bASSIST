class LsaRunsDatatable
  ...
  def fetch_lsa_runs
    ...
    lsa_runs = LsaRun.from("(#{lsa_runs.to_sql})").
                 select("id,created_at,updated_at,type,ideal_solution,first_scored_text,second_scored_text,error_message,exercise_id,first_text_score,second_text_score,lsa_server_id, schedule_time,user_id,start_time,stop_time,lecture_id")
